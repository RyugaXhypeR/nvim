...
_G.packer_plugins = {
  ...
  base46 = {
    ...
    loaded = true,
    only_config = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/base46",
  ...
  extensions = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/extensions",
  ...
  nvterm = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/nvterm",
  ...
  ui = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/ui",
...
try_loadstring("\27LJ\2\n7\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\28plugins.configs.copilot\frequire\0", "config", "copilot.vim")
